 ...
 * on 04/10/17.
 */
open class StaticMethodResultNoReturn<ENTITY : PlatypusEntity, PARAM : StaticMethodParams>(private val stackOnChange: StaticMethodDefNoReturn<ENTITY, PARAM>) {
...
class StaticMethodDefNoReturn<ENTITY : PlatypusEntity, PARAM : StaticMethodParams>(
...
open class StaticMethodResultWithReturn<ENTITY : PlatypusEntity, PARAM : StaticMethodParams, RETURN : StaticMethodReturn>(private val stackOnChange: StaticMethodDefWithReturn<ENTITY, PARAM, RETURN>) {
    val errors: MutableSet<RuntimeException> = mutableSetOf()
    //    val original = lazy { entity.klass[entity.id] }
    val warnings: MutableSet<String> = mutableSetOf()
    val ctx: MutableMap<String, Any> = mutableMapOf()
...
class StaticMethodDefWithReturn<ENTITY : PlatypusEntity, PARAM : StaticMethodParams, RETURN : StaticMethodReturn>(
